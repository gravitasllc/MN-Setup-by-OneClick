...
CONFIGFOLDER='/root/.StakeCubeCore'
COIN_DAEMON='stakecubed'
COIN_CLI='stakecube-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/stakecube/stakecube/releases/download/v1.0.0.1/StakeCube-1.0.0.1-ubuntu_16.04_daemon.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_BOOTSTRAP='https://github.com/stakecube/stakecube/releases/download/v1.0.0.1/bootstrap.zip'
...
addnode=95.179.165.19
addnode=209.250.224.166
addnode=108.61.212.198
addnode=78.141.211.79
addnode=95.179.209.111
...
function important_information() {
 ...
 echo -e "${GREEN}stakecube-cli masternode status${NC}"
 echo -e "${GREEN}stakecube-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
